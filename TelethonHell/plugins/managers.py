...
async def _(event):
    ...
    OUTPUT = f"**Files in 𝘼𝙡𝙣𝙐𝙨𝙚𝙧𝘽𝙤𝙩 DOWNLOADS Folder:**\n"
...
CmdHelp("managers").add_command(
    "ls_local", None, "Gives the list of downloaded medias in your AlnIserBot server."
).add_command(
    "ls_root", None, "Gives the list of all files in root directory of AlnUserBot repo."
).add_command(
    "ls_saved", None, "Gives the list of all files in Saved directory of your AlnIserBot server"
).add_command(
